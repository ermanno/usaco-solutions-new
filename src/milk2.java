	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 1; i < N; i++) {
			...
			if (currentWorking.end < tempInt.beginning) {
				...
				// the new interval is the current one, furthermore it could already be longer than the max one
			...
			// if the interval does not begin after the current one, but ends after the current one
